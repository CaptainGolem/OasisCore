...
package net.mcreator.oasiscore.world.dimension;
...
public class MemoriaDimension {
	@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
	public static class MemoriaSpecialEffectsHandler {
		@SubscribeEvent
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(ResourceLocation.parse("oasiscore:memoria"), customEffect);
		}
	}
}
